...
## From Raw
The raw data for this analysis is avaliable through ([via](https://www.dropbox.com/s/61auiyewty5n6ga/Creston%20Respirometry%20Raw%20Data%20-%20ALL.csv?dl=0)) 
...
myyu.params <- MRUpdate(myyu.mr, "M.yumanensis", params = bat.update)
```
