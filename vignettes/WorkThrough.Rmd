...
dat.dirty <- read.csv("C:/Users/crhranac//Dropbox/ShareDocs/Creston Respirometry Raw Data - ALL.csv")
...
```{r}
env <- BuildEnv(temp.range = c(-5, 20), hum.range = c(60,100), range.res = .5)
env <- BuildEnv(c(1,10), c(90,100), 1)
