...
#'
#' \code{fungalSelect} select between presets of scaled fungal growth to apply
#' to the model.
#'
...
#' @example ExampleScripts/fungalSelect_ex.R
#'
#' @family Fungal Functions
#'
#' @seealso \code{\link{fungalLoad}},  \code{\link{fungalGrowth}},
#' \code{\link{scaleFungalGrowth}}
#' @export
fungalSelect <- function(choose){
